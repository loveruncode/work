      ...
      <div class="card-body p-3 p-md-4 p-xl-5">
        <div class="row">
          <div class="col-12">
            <div class="mb-4">
              <h3>Register</h3>
              <p>Please fill in the information to register an account below</p>
            </div>
          </div>
        </div>
          ...
          <div class="row gy-3 overflow-hidden">
            ...
            <div class="col-12">
                <div class="form-floating mb-3">
                  <input type="password" class="form-control" name="password_confirm" id="password" value="" placeholder="Password" required>
